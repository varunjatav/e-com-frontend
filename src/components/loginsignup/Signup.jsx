      ...
      >
        <form action="" onSubmit={getformdata}>
          <div className={styles.main}>
            ...
            <div className={styles.imagediv}>
              <div className={styles.img}>
                <img
                  ...
                  src="data:image/png;base64,"
                  alt=""
                />
                <div
                  style={{
            ...
            <div style={{ marginTop: "1rem" }}>
              <div style={{ marginLeft: "-16rem" }}>Enter Email</div>
              <input
                ref={emailRef}
                style={{
                  marginLeft: "0rem",
            ...
            <div style={{ marginTop: "1rem" }}>
              <div style={{ marginLeft: "-16.5rem" }}>Password</div>
              <input
                ref={passRef}
                style={{
                  marginLeft: "0rem",
            ...
            <div>
              ...
              <RouterLink style={{ textDecoration: "none" }} to={"/login"}>
                <span style={{ color: "rgb(222, 87, 229)", cursor: "pointer" }}>
                  Login
                </span>
              </RouterLink>
            </div>
